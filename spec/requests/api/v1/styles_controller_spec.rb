...
describe "Styles API" do
  ...
  describe "#index" do
    it "returns all styles associated with a designer" do
      get "/api/v1/designers/#{@novella_royalle.id}/styles"
  ...
  describe "#show" do
    context "valid style" do
      it "returns an individual style" do
        get "/api/v1/designers/#{@novella_royalle.id}/styles/#{@jasmine_jumpsuit.id}"
    ...
    context "invalid style" do
      it "returns an error message" do
        get "/api/v1/designers/#{@novella_royalle.id}/styles/#{@aribella_top.id}"
  ...
  describe "#create" do
    context "valid attributes" do
      it "creates a new instance of a style" do
        post "/api/v1/designers/#{@novella_royalle.id}/styles", params: {style: {name: "Eli Blouse",
